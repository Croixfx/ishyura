...
<html lang="en">
  <head>
    ...
    <style>
      ...
      .card { max-width: 38rem; width: 100%; text-align: center; padding: 2rem; background: #fff; border: 1px solid #e5e7eb; border-radius: 0.75rem; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.05); }
      h1 { font-size: 1.25rem; margin: 0 0 0.5rem; font-weight: 600; }
      p { color: #4b5563; margin: 0 0 1.5rem; font-size: 0.875rem; }
      pre { text-align: left; background: #f3f4f6; color: #b91c1c; font-size: 0.75rem; padding: 1rem; border-radius: 0.5rem; overflow-x: auto; max-height: 250px; margin-bottom: 1.5rem; white-space: pre-wrap; word-break: break-all; }
